...
public onToggleLoopAnimate(): void {
  ...
  const loadAndProcessSublist = () => this.apiService.sublist(
    params,
    parentLevel + 1,
  ...
  // For field types without supplier/price handling (e.g., type 3), still load subfields
  return loadAndProcessSublist();
}
